...
export const TRANSLATIONS: Record<Language, any> = {
  en: {
    ...
    syncStatusOnline: "Online (Cloud Sync Active)",
    syncStatusOffline: "Offline Mode (Local Save Active)",
  ...
  fr: {
    ...
    syncStatusOnline: "En ligne (synchronisation active)",
    syncStatusOffline: "Mode hors ligne (sauvegarde locale active)",
  ...
  de: {
    ...
    syncStatusOnline: "Online (Cloud-Synchronisation aktiv)",
    syncStatusOffline: "Offline-Modus (Lokale Speicherung aktiv)",
  ...
  ru: {
    ...
    syncStatusOnline: "В сети (облако активно)",
    syncStatusOffline: "Автономный режим (сохранение на устройстве)",
  ...
  tr: {
    ...
    syncStatusOnline: "Çevrimiçi (Bulut Eşitleme Aktif)",
    syncStatusOffline: "Çevrimdışı Modu (Yerel Kayıt Aktif)",
