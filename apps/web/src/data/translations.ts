...
export const TRANSLATIONS: Record<Language, any> = {
  ...
  fr: {
    ...
    localFirst: "Stockage local (privé jusqu'à ce que vous choisissiez de synchroniser)",
    ...
    loginRestore: "Se connecter ou demander des retours",
  ...
  de: {
    ...
    localFirst: "Lokaler Speicher (privat, bis du dich für die Synchronisierung entscheidest)",
    ...
    loginRestore: "Anmelden oder Feedback sammeln",
    loginTitle: "Anmelden",
  ...
  ru: {
    ...
    localFirst: "Локальное хранение (конфиденциально до включения синхронизации)",
    ...
    loginRestore: "Войти или запросить отзывы",
    loginTitle: "Вход",
